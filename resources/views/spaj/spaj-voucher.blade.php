...
<div class="content">
    ...
    <div class="bg-gd-primary">
        <div class="hero-static content content-full bg-white" data-toggle="appear">
            ...
            @csrf
                    <!-- Vital Info -->
                    <h2 class="content-heading text-black">Informasi Voucher</h2>
                    <div class="row items-push">
                        ...
                        <div class="col-lg-7 offset-lg-1">
                            <div class="form-group">
                                <label for="name">Voucher Code <span class="text-danger">*</span></label>
                    ...
                    <div class="row items-push">
                        ...
                        <div class="col-lg-7 offset-lg-1">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror datepicker" id="customer_dob" name="customer_dob" required autocomplete="customer_dob" onchange="myselfRelation()" value="{{ old('customer_dob') }}" placeholder="dd/mm/yyyy">
                                @error('customer_dob')
                                    <p style="color:red">
                                        <strong>{{ $message }}</strong>
                                    </p>
                            ...
                            <div class="form-group">
                                ...
                                <input type="name" class="form-control @error('icitizen_id') is-invalid @enderror" id="customer_citizen_id" name="customer_citizen_id" required autocomplete="customer_citizen_id" onchange="myselfRelation()" value="{{ old('customer_citizen_id') }}" placeholder="contoh: 1234123412341234 (16 digit angka)" maxlength=16>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control @error('name') is-invalid @enderror" id="customer_email" name="customer_email" required autocomplete="customer_email" onchange="myselfRelation()" value="{{ old('customer_email') }}" placeholder="contoh: budidarmawan@gmail.com">
                            ...
                            <div class="form-group">
                                <label class="css-control css-control-primary css-checkbox">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-11">
                                            Saya telah membaca dan setuju dengan <b>syarat ketentuan</b> yang berlaku.
...
<!-- Pop Out Modal -->
{{-- <div class="modal fade" id="modal-popout-tm" tabindex="-2" role="dialog" aria-labelledby="modal-popout" aria-hidden="true">
    <div class="modal-dialog modal-dialog-popout" role="document">
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                <div class="block-header bg-primary">
                    <h3 class="block-title">Download Training Materials</h3>
                    <div class="block-options">
                        <button type="button" class="btn-block-option" data-dismiss="modal" aria-label="Close">
                            <i class="si si-close"></i>
                        </button>
                ...
                <div class="block-content">
                    <p>Silahkan didownload untuk melihat Training Materials - Sequis Mikro Sejahtera.</p>
                </div>
            </div>
            <div class="modal-footer">
                <form method="GET">
                    @csrf
                    <input type="submit" class="btn btn-alt-primary" value="Download" formaction="{{ route('training-material.download') }}"/>
                </form>
            </div>
        </div>
    </div>
